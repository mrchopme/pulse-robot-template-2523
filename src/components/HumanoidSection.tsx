        ...
        <div className="container px-6 lg:px-8 mx-auto h-full flex flex-col">
          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
            ...
            pointerEvents: isSecondCardVisible ? 'auto' : 'none'
              ...
              <div className="absolute top-4 right-4 z-20">
                <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-white">
                  <span className="text-sm font-medium">The Copy-Paste Tax</span>
                </div>
              </div>
            ...
            pointerEvents: isThirdCardVisible ? 'auto' : 'none'
              ...
              <div className="absolute top-4 right-4 z-20">
                <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-white">
                  <span className="text-sm font-medium">The Context Collapse</span>
                </div>
              </div>
              
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4 mx-[13px] my-[6px]">Every new tool is a fresh start.
Re-explain everything.
Rebuild from zero.</h3>
                </div>
              </div>
            </div>
          </div>
