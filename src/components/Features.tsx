      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Meet Your Universal Translator
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Email becomes task. Calendar becomes doc. Seamless translates it all."
            index={0}
          />
          <FeatureCard
            ...
            description="Your context and patterns travel with you. No more starting over."
            index={1}
          />
          <FeatureCard
            ...
            title="Orchestrates Intelligently"
            description="Seamless conducts your apps like a symphony."
            index={2}
          />
        </div>
      </div>
